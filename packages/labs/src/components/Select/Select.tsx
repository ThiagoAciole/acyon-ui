            ...
            <FormField label={label} error={error} hint={supportText} full={full} className={className} htmlFor={generatedId}>
                <div ref={rootRef} className={classNames('select', full && 'select--full')}>
                    ...
                    >
                        ...
                        <span className="select__icon"><ChevronDownIcon size={16} /></span>
                    </div>
                        ...
                        <div className="select__menu">
                            {searchable && (
                                <div className="select__search">
                                    <span className="select__search-icon"><SearchIcon size={14} /></span>
                                    <input
                                        ref={searchInputRef}
                                ...
                                {filteredOptions.length > 0 ? filteredOptions.map((option) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {isSelected && <span className="select__option-check"><CheckIcon size={14} /></span>}
                                        </li>
                                    );
                                }) : (
